...
MIDDLEWARE = [
    ...
    "mysite.middleware.PermissionsPolicyMiddleware",
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='agorablog@proton.me')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='agorablog@proton.me')